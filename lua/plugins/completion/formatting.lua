...
local disabled_worksapce_path = home .. "/.config/nvim/lua/plugins/completion/format_disabled_dirs.txt"
...
function M.enable_format_on_save(is_configured)
  ...
  vim.api.nvim_create_autocmd("BufWritePre", {
    ...
    callback = function()
      require("plugins.completion.formatting").format({ timeout_ms = opts.timeout, filter = M.format_filter })
    end,
  })
